...
namespace MiiskoWiiyaas.Core
{
    ...
    public class GameSystems
    {
        ...
        {
            matchFinder.OnMatchProcessed += gemMover.MatchFinder_OnMatchProcessed;
            matchFinder.OnMatchProcessed += scoreManager.MatchFinder_OnMatchProcessed;
            matchFinder.OnMatchProcessed += uIManager.MatchFinder_OnMatchProcessed;
            matchFinder.OnMatchFound += scoreManager.MatchFinder_OnMatchFound;
            ...
            scoreManager.OnBonus += uIManager.ScoreManager_OnBonus;
